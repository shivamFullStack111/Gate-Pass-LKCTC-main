...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (user) {
      if (user?.role == "hod" || user?.role == "director"||user?.role=='keeper') {
        getAllRequests();
      }
    }
  }, [user]);
